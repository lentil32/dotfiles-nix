...
variant_files() {
  ...
  case "${variant}" in
    ...
    base_full)
      cat <<'EOF'
nvim/rust/plugins/smear-cursor/src
nvim/rust/plugins/smear-cursor/Cargo.toml
EOF
      ;;
    frame_static)
      cat <<'EOF'
nvim/rust/plugins/smear-cursor/src/types.rs
nvim/rust/plugins/smear-cursor/src/state/mod.rs
nvim/rust/plugins/smear-cursor/src/core/runtime_reducer/mod.rs
nvim/rust/plugins/smear-cursor/src/draw/render/particles.rs
EOF
      ;;
    animation)
      cat <<'EOF'
nvim/rust/plugins/smear-cursor/src/animation/mod.rs
EOF
      ;;
    geometry)
      cat <<'EOF'
nvim/rust/plugins/smear-cursor/src/draw/render/geometry.rs
nvim/rust/plugins/smear-cursor/src/draw/render/cell_draw.rs
EOF
      ;;
    probe_plan)
      cat <<'EOF'
nvim/rust/plugins/smear-cursor/src/draw/render_plan/mod.rs
nvim/rust/plugins/smear-cursor/src/draw/apply.rs
nvim/rust/plugins/smear-cursor/src/draw/mod.rs
EOF
      ;;
    *)
