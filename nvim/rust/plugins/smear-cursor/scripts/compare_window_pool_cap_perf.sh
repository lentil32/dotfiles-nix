...
export SMEAR_COMPARE_REPORT_COMMAND="${SMEAR_COMPARE_REPORT_COMMAND:-SMEAR_PERF_REPORT_FILE=plugins/smear-cursor/perf/current.md ${script_dir}/capture_perf_snapshot.sh ${base_ref}}"
