...
mod palette;
mod prepaint;
mod prepaint_compaction;
mod redraw;
pub(crate) mod render_plan;
mod resource_close;
mod resource_guard;
mod resource_quarantine;
#[cfg(test)]
mod test_support;
mod window_pool;
...
pub(crate) use cleanup::clear_current_tab_render_artifacts;
...
pub(crate) use cleanup::recover_draw_resources;
...
pub(crate) use floating_windows::clear_namespace_and_hide_floating_window_with;
pub(crate) use floating_windows::close_floating_window_with_autocmds_suppressed;
pub(crate) use floating_windows::delete_floating_buffer_with_autocmds_suppressed;
...
pub(crate) use resource_quarantine::ResourceQuarantine;
