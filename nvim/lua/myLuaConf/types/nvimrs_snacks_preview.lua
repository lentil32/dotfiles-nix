...
---@class nvimrs_snacks_preview.ImageRef
---@field src? string

---@class nvimrs_snacks_preview.DocFindArgs
---@field buf integer
---@field token integer
---@field win integer
---@field imgs? nvimrs_snacks_preview.ImageRef[]

---@class nvimrs_snacks_preview.AttachDocPreviewArgs
---@field buf integer
---@field win integer
---@field path string

---@class nvimrs_snacks_preview
...
---@param args nvimrs_snacks_preview.DocFindArgs
function M.on_doc_find(args) end

---@param args nvimrs_snacks_preview.AttachDocPreviewArgs
