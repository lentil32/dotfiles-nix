...
---@alias nvimrs_plugin_util.OptionValue nil|boolean|integer|number|string|table
...
---@param opts table<string, nvimrs_plugin_util.OptionValue>
...
---@overload fun(buf: integer|nil, opt: string): nvimrs_plugin_util.OptionValue
---@generic T
---@param buf integer|nil
---@param opt string
---@param default T
...
---@overload fun(win: integer|nil, opt: string): nvimrs_plugin_util.OptionValue
---@generic T
---@param win integer|nil
---@param opt string
---@param default T
...
---@overload fun(buf: integer|nil, name: string): nvimrs_plugin_util.OptionValue
---@generic T
---@param buf integer|nil
---@param name string
---@param default T
